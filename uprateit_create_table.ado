...
program define uprateit_create_table
    ...
    if ("`country'" == "de") {
        ...
        // Consumer price index, Federal Statistical Office and ifo Economic Forecast
        else if ("`account'" == "cpi-ifo") {
            mat `g' = ( 1949,   -6.6  \ ///
                        1950,   -9.6  \ ///
                        1951,    9.2  \ ///
                        1952,   -0.3  \ ///
        ...
        // Consumer price index, Federal Statistical Office and Gemeinschaftsdiagnose
        else if ("`account'" == "cpi-gd") {
            mat `g' = ( 1949,   -6.6  \ ///
                        1950,   -9.6  \ ///
                        1951,    9.2  \ ///
                        1952,   -0.3  \ ///
